...
--
-- Hôte : localhost:8889
-- Généré le : mer. 09 nov. 2022 à 15:02
...
(NULL, 1, 1, 'Facile', 4200, '2022-11-09'),
(NULL, 9, 1, 'Facile', 2830, '2022-11-09'),
(NULL, 7, 1, 'Normal', 6030, '2022-11-09'),
(NULL, 8, 1, 'Normal', 7420, '2022-11-09'),
(NULL, 10, 1, 'Facile', 5023, '2022-11-09'),
(NULL, 1, 1, 'Normal', 7300, '2022-11-09');
...
(NULL, 'mailcommun@yahoo.com', '12345', 'Bgdelastreet', '2022-11-09', NULL),
(NULL, 'mailpascommun@yahoo.com', '12345', 'RoroDu95', '2022-11-09', NULL),
(NULL, 'mailrare@yahoo.com', '12345', 'Jimmy99', '2022-11-09', NULL),
(NULL, 'mailmegarare@yahoo.com', '12345', 'WakandaWarrior', '2022-11-09', NULL),
(NULL, 'maillegendaire@yahoo.com', '12345', 'SugmaMale', '2022-11-09', NULL);
...
--
ALTER TABLE `Message`
  MODIFY `IdentiMsg` int(11) NOT NULL AUTO_INCREMENT;
